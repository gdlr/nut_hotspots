...
# Mask removes cells that don't have a centroid in the EEZ. This isn't good...
...
if(!file.exists(here("cropped_rasters", "OHI_nutrient_pollution_reproject.tif"))){
  ...
  nut_crop <- mask_fx(nut_raw, us_eez_moll)
...
These data are from the World Ocean Database.

But these kinda suck.
```{r}
# 
# phos_obs_2017 <- read_csv(here("data", "WOD_csv", "phos_std_2017.csv"))
# 
# phos_2017_sf <- st_as_sf(phos_obs_2017, coords = c("Latitude", "Longitude"))
```


What about NOAA's data from 1993?
...
These are calculated seaweed distributions from...Ilan?
At least from emlab
